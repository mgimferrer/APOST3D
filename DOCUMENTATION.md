...
1. `name-input.fchk`: Gaussian-type formatted checkpoint file. It can be directly obtained from a Gaussian or Q-Chem run. It can also be generated by i/O converters such as iodata (https://github.com/theochem/iodata)
