...
* [Extracting .fchk, .dm1 and .dm2 files from pySCF](#extracting-fchk-dm1-and-dm2-files-from-pyscf)
...
The files containing the information of the RDM1 and RDM2 (.dm1 and .dm2) are mandatory for this type of analysis. They can be obtained from a pySCF run using the *apost3d.py* utility, as described [here](#extracting-fchk-dm1-and-dm2-files-from-pyscf). 
